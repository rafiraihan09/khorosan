...
// Initial sample products data - Updated for Islamic brand
const initialProducts: Product[] = [
  {
    id: '1',
    name: 'Alpine Explorer Jacket',
    ...
    category: 'Mountain Range',
    description: 'Premium weather-resistant jacket for mountain adventures',
    longDescription: 'Crafted from high-performance materials, this jacket combines durability with comfort. Features include waterproof zippers, reinforced shoulders, and breathable mesh lining. Perfect for hiking, climbing, and outdoor exploration while maintaining modest coverage.',
    sizes: ['XS', 'S', 'M', 'L', 'XL', 'XXL'],
    colors: ['Black', 'Navy', 'Forest Green'],
    inStock: true,
    image: 'https://images.pexels.com/photos/1183266/pexels-photo-1183266.jpeg?auto=compress&cs=tinysrgb&w=800'
  },
  {
    ...
    category: 'Artillery Range',
    description: 'Durable tactical pants with reinforced construction',
    longDescription: 'Military-grade construction meets everyday comfort. These pants feature reinforced knees and seat, multiple cargo pockets, and rip-resistant fabric. Ideal for tactical training and outdoor activities. Now featuring Arabic calligraphy inspired by Gaza wall art.',
    sizes: ['28', '30', '32', '34', '36', '38', '40'],
    colors: ['Black', 'Khaki', 'Olive Drab'],
    inStock: true,
    image: 'https://images.pexels.com/photos/1040945/pexels-photo-1040945.jpeg?auto=compress&cs=tinysrgb&w=800'
  },
  {
    ...
    category: 'Urban Wear',
    description: 'Sophisticated protection for city life',
    longDescription: 'The perfect blend of style and function for urban environments. Features include water-resistant coating, insulated lining, and sophisticated tailoring. Designed for the modern Muslim professional who demands both style and modesty.',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    colors: ['Black', 'Charcoal', 'Navy'],
    inStock: true,
    image: 'https://images.pexels.com/photos/1549200/pexels-photo-1549200.jpeg?auto=compress&cs=tinysrgb&w=800'
  ...
  {
    id: '4',
    name: 'Khorosan Heritage Hoodie',
    price: 149,
    category: 'Mountain Range',
    description: 'Comfortable hoodie celebrating Islamic heritage',
    longDescription: 'Soft cotton blend with moisture-wicking properties. Features subtle Islamic geometric patterns and the Khorosan logo. Perfect for layering or wearing alone during moderate weather conditions. 25% of profits support Palestine.',
    sizes: ['XS', 'S', 'M', 'L', 'XL', 'XXL'],
    colors: ['Black', 'Navy', 'Forest Green'],
    inStock: true,
    image: 'https://images.pexels.com/photos/346885/pexels-photo-346885.jpeg?auto=compress&cs=tinysrgb&w=800'
  ...
  {
    id: '5',
    name: 'Gaza Solidarity Shirt',
    price: 89,
    category: 'Artillery Range',
    description: 'Lightweight shirt with Gaza wall art inspiration',
    longDescription: 'Quick-dry fabric with UPF protection. Features Arabic calligraphy inspired by the walls of Gaza. Designed for long days with comfort and purpose in mind. Every purchase directly supports Palestinian humanitarian aid.',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
  ...
  {
    id: '6',
    name: 'Ummah Unity Vest',
    price: 219,
    category: 'Artillery Range',
    description: 'Multi-functional vest for the modern Muslim',
    longDescription: 'Modular vest system with multiple pockets for daily essentials. Features subtle Islamic geometric patterns and the Khorosan logo. Perfect for outdoor activities while maintaining modest coverage and supporting our Palestinian brothers.',
    sizes: ['S', 'M', 'L', 'XL'],
    colors: ['Black', 'Navy', 'Olive Drab'],
    inStock: false, // This one starts as out of stock
    image: 'https://images.pexels.com/photos/1549200/pexels-photo-1549200.jpeg?auto=compress&cs=tinysrgb&w=800'
  },
  {
    id: '7',
    name: 'Masjid Weather Guard',
    price: 259,
    category: 'Urban Wear',
    description: 'All-weather protection with Islamic elegance',
    longDescription: 'Versatile jacket suitable for various weather conditions. Features sealed seams, adjustable hood, and modern cut that respects Islamic dress codes. Perfect for commuting to the masjid or professional environments.',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
